  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center p-3 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg transition-all duration-800 hover:scale-105"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative z-10 w-full max-w-md p-6 mx-4 bg-white rounded-lg shadow-xl border-l-4 border-amber-500">
            <button
              onClick={() => setIsModalOpen(false)}
            ...
            <div
              className={`flex items-center gap-3 p-4 mb-4 rounded-md ${isBlinking ? 'bg-red-100 text-red-800' : 'bg-red-600 text-white'} transition-colors duration-800`}
            >
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm text-white bg-red-600 rounded-md hover:bg-red-700 transition-colors flex items-center gap-2"
                >
